...
enum AppConstants {
    static let appName = "ConsTrac"
    static let apiBaseURL = "https://api.constrac.example.com/v1"
    ...
    enum Notifications {
        static let attendanceHistoryDidClear = Notification.Name("constrac.attendanceHistoryDidClear")
    }
}
